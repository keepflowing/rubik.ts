...
export class Mat4
{
    ...
    public multiply (other: any)
    {
        return this.concat(other);
    }

    public multiplyVector3 (pos: Vec3)
    {
        let e = this.elements;
        let p = pos.elements;
        let v = new Vec3();
    ...
    public multiplyVector4 (pos: Vec4)
    {
        let e = this.elements;
        let p = pos.elements;
        let v = new Vec4();
    ...
    public setOrtho (left: number, right: number, bottom: 
      number, top: number, near: number, far: number)
    {
        let e, rw, rh, rd;
    ...
    public ortho (left: number, right: number, bottom: 
      number, top: number, near: number, far: number)
    {
        return this.concat(new Mat4().setOrtho(left, right, bottom, top, near, far));
    }

    public setFrustum (left: number, right: number, bottom: 
      number, top: number, near: number, far: number)
    {
        let e, rw, rh, rd;
    ...
    public frustum (left: number, right: number, bottom: 
      number, top: number, near: number, far: number)
    {
        return this.concat(new Mat4().setFrustum(left, right, bottom, top, near, far));
    }

    public setPerspective (fovy: number, aspect: number, 
    ...
    public perspective (fovy: number, aspect: number, 
      near: number, far: number)
    {
    ...
    public dropShadow (plane: any, light: any)
    {
        let mat = new Mat4();
        let e = mat.elements;
